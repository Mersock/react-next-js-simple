...
const post = ({url}) => (
    <Layout title={url.query.title}>
        <p>Enim commodo in ad proident proident tempor incididunt occaecat do est enim mollit. Laborum amet minim dolor ullamco id amet fugiat magna anim ad cupidatat laborum. Eiusmod aliquip Lorem anim in sunt non nisi consectetur ut reprehenderit duis anim.
